...
@onready var player_detector: ShapeCast3D = $CharacterRig/PlayerDetector
@onready var area_attack: ShapeCast3D = $CharacterRig/AreaAttack
...
func _physics_process(_delta: float) -> void:
	...
	if is_on_floor():
		...
		velocity_target.y -= gravity * _delta
